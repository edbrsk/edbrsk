...
We will need to download a .apk to investigate to get our reverse shell.
...
![](/posts/Write-Ups/htb-routerspace/static-page.png)
...
![](/posts/Write-Ups/htb-routerspace/routerspace_apk.png)
...
![](/posts/Write-Ups/htb-routerspace/check_device_access.png)

## RCE 

Let's send it to the repeater, and let's try if we can inject commands, and... Yes, we can!

![](/posts/Write-Ups/htb-routerspace/rce.png)
...
![](/posts/Write-Ups/htb-routerspace/id_rsa.png)
